    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                mBinding.detail.setText("Code Sent");
                break;
            case STATE_VERIFY_FAILED:
                ...
                mBinding.detail.setText("Verification Failed");
                break;
            case STATE_VERIFY_SUCCESS:
                ...
                disableViews(mBinding.buttonStartVerification, mBinding.buttonVerifyPhone, mBinding.buttonResend, mBinding.fieldPhoneNumber,
                        mBinding.fieldVerificationCode);
                mBinding.detail.setText("Verification Succeed");
                ...
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        ...
                        mBinding.fieldVerificationCode.setText("Instant Validation");
                    }
                }
            ...
            case STATE_SIGNIN_FAILED:
                ...
                mBinding.detail.setText("Sign In Failed");
                break;
        ...
        if (user == null) {
            ...
            mBinding.detail.setText("STATUS FMT"+user.getUid());
        }
    }
